/**
 * Fairness Services - Application Layer Export
 *
...
/**
 * Fairness Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for fairness domain.
 */
