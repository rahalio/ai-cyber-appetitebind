/**
 * Appetite Services - Application Layer Export
 *
...
/**
 * Appetite Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for appetite domain.
 */
