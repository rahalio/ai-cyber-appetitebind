/**
 * Assessments API Types
 *
 * API contract types come from @appetitebind/core.
 * This file contains ONLY re-exports - no local API contract definitions.
 */

// ============================================================================
// API Type Re-exports (from @appetitebind/core)
// ============================================================================
...
// export type CoreAssessmentsItem = AssessmentsItem;
