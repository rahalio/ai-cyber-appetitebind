/**
 * VariationRepository - DynamoDB Implementation
 *
...
/**
 * VariationRepositoryDdb
 *
 * DDD: Infrastructure adapter implementing Variation repository using DynamoDB.
 * Generated from x-dynamodb metadata in OpenAPI schema.
 */

import type { VariationRepository } from "@appetitebind/services/governance";
...
/**
 * VariationRepositoryDdb using DynamoDB table (type: core)
 *
 * Entity Type: ALGORITHM_VARIATION
 * Entity Token: ALGORITHM_VARIATION
 * SK Prefix: ALGORITHM_VARIATION
 */
export class VariationRepositoryDdb implements VariationRepository {
  private readonly TABLE_NAME: string;
  // Metadata from x-dynamodb annotation - all values are dynamic
  private readonly ENTITY_TYPE = "ALGORITHM_VARIATION";
  private readonly ENTITY_TOKEN = "ALGORITHM_VARIATION";
  private readonly SK_PREFIX = "ALGORITHM_VARIATION";
  ...
  private readonly ENTITY_TYPE_PK = "ALGORITHM_VARIATIONS";
