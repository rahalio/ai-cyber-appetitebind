 ...
 * BreachRepositoryDdb
 *
 * DDD: Infrastructure adapter implementing Breach repository using DynamoDB.
 * Generated from x-dynamodb metadata in OpenAPI schema.
 */

import type { BreachRepository } from "@appetitebind/services/predictions";
...
/**
 * BreachRepositoryDdb using DynamoDB table (type: core)
 *
 * Entity Type: BREACH_PREDICTION
 * Entity Token: BREACH_PREDICTION
 * SK Prefix: BREACH_PREDICTION
 */
export class BreachRepositoryDdb implements BreachRepository {
  ...
  private readonly ENTITY_TYPE = "BREACH_PREDICTION";
  private readonly ENTITY_TOKEN = "BREACH_PREDICTION";
  private readonly SK_PREFIX = "BREACH_PREDICTION";
  ...
  private readonly DOMAIN = "PREDICTIONS";
  private readonly ENTITY_TYPE_PK = "BREACH_PREDICTIONS";
  private generateCorrelationId(): string {
    const domainPrefix = "prd";
  ...
  async listBreachPredictions(input: Parameters<BreachRepository['listBreachPredictions']>[0]): Promise<Awaited<ReturnType<BreachRepository['listBreachPredictions']>>> {
